...
def main():
    print("Loading data...")
    # Load data
    ipl_df = downcast_df(pd.read_csv(os.path.join(DATA_DIR, 'ipl_data_enriched.csv')))
    matches_df = downcast_df(pd.read_csv(os.path.join(DATA_DIR, 'ipl_data_cleaned.csv'))) # Use cleaned matches for match-level info

    batting_ratings_df = downcast_df(pd.read_csv(os.path.join(DATA_DIR, 'glicko_batting_ratings.csv')))
    bowling_ratings_df = downcast_df(pd.read_csv(os.path.join(DATA_DIR, 'glicko_bowling_ratings.csv')))
    player_impact_batter_df = downcast_df(pd.read_csv(os.path.join(DATA_DIR, 'player_impact_batter.csv')))
    player_impact_bowler_df = downcast_df(pd.read_csv(os.path.join(DATA_DIR, 'player_impact_bowler.csv')))
    print("Data loaded.")
    ...
    print("Aggregating player performance...")
    ...
    print("Player performance aggregated.")

    # Calculate strike rate and economy rate for the match
    print("Calculating strike rate and economy rate...")
    ...
    print("Strike rate and economy rate calculated.")

    # Merge Glicko ratings and impact scores
    print("Merging Glicko ratings and impact scores...")
    ...
    print("Glicko ratings and impact scores merged.")
    ...
    print("Preparing match-level features...")
    ...
    print("Match-level features prepared.")

    # Encode winner for classification
    print("Encoding winner...")
    le = LabelEncoder()
